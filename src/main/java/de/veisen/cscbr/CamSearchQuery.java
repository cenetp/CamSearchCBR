...
public class CamSearchQuery extends HttpServlet {
  ...
  private void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    try (PrintWriter out = response.getWriter()) {
      ...
      out.println("<body>");
      out.println(
          "<div id='nav'><p>CamSearchCBR <span class='page-title'>/ Query</span></p></div>");
      out.println(
          "<form method='POST' action='CamSearchResults' name='queryForm'>" + "<div class='query'>"
              ...
              + "<option value='43'>4:3</option>" + "<option value='54'>5:4</option>" + "</select>"
              + "</div>"
              + "<div class='inputfield'>"
              + "<label for='effpix'>Effective pixels (million)</label>"
              + "<input type='text' name='effpix' value='16'>" + "</div>"
              + "<div class='inputfield'>"
              ...
              + "<input type='text' name='isomax' value='6400'>" + "</div>"
              + "<div class='inputfield'>"
